% x, h funciones anónimas que serán operadas con convolución
% f función anónima del resultado analítico
% iintx e fintx limitan el eje x en las gráficas
% iinty1 e finty1 limitan el eje y en las gráfica de la convolución
% iinty1 e finty2 limitan el eje y en las gráfica del resultado. Tomar en
% cuenta el valor máximo que alcanza cada función y multiplicarlas. 
% En una segunda ejecución, ajustar los límites al resultado
...
% intervalos pequeños (preferentemente 0.1)
function convconm2(x,h,f, iintx, fintx, iinty1, finty1, iinty2, finty2, tvec)
  ...
  tau = iintx:dtau:fintx; % Intervalo de visualización del resultado
  ...
  for t = tvec, % Cantidad de traslaciones
      ...
      axis ([tau(1) tau(end) iinty1 finty1]); % límites de los ejes
      ...
      axis ([tau(1) tau(end) iinty2 finty2]); % límites del eje
      grid; % malla
